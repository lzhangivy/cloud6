...
if(empty($_GET)){	// read database
    if($mysqli){
        if($tutorial != 'final') $query = "SELECT *FROM QUIZ WHERE tutorial = '$tutorial' ORDER BY RAND();";
...
//    writeSocreToDatabase($score);
    ...
    //$destination_email = "RITISTprofessor@gmail.com, ivy66666@qq.com";
    $email_subject = " QUIZ - Photoshop ISTE240.01";
    $email_body = "Visitor:  $visitor\n";
    $email_body .= "Score for final quiz $score\n";
